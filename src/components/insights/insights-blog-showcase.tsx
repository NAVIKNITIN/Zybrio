    ...
    <section className="flex-1" id="blog">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
        <div>
          ...
          <h2 className="mt-3 max-w-[38rem] text-[2.6rem] font-semibold leading-[0.98] tracking-[-0.06em] text-white sm:text-[3.25rem]">
            {blogShowcase.title}
          </h2>
        </div>
        ...
        <button
          type="button"
          onClick={onViewAll}
          className="inline-flex h-11 w-fit shrink-0 items-center gap-2 rounded-[0.95rem] border border-white/10 bg-white/[0.03] px-5 text-base font-semibold text-white transition hover:border-[#a4ea00]/45 hover:bg-white/[0.07] sm:h-12"
        >
      ...
      <article className="relative mt-10 min-h-[24rem] overflow-hidden rounded-[1.3rem] bg-[#ddff8c] shadow-[0_30px_90px_rgba(0,0,0,0.22)] sm:mt-12 sm:min-h-[34.5rem]">
        <Image
        ...
        <div className="relative z-10 flex min-h-[24rem] flex-col justify-between px-6 py-6 sm:min-h-[34.5rem] sm:px-9 sm:py-8">
