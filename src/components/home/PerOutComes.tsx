    ...
    <div className="flex flex-col gap-3 mt-12">
        {statsData.map((item, i) => (
            <motion.div
                ...
                className={`flex items-center justify-between rounded-full border border-[#154015] bg-[#041C04]/90 px-5 py-1.5 w-[340px] ${i === 1 ? "ml-14" : ""
                    }`}
            >
                ...
                <div className="flex items-center gap-1.5">
                    {[...Array(5)].map((_, index) => (
                        <span
                            key={index}
                            className={`h-[9px] w-[9px] rounded-full ${index === 4
...
export default function PerformanceSection() {
    return (
        <section className="relative bg-[#001F00] h-[200vh] text-white" style={{ minHeight: "100vh" }}>
                    ...
                    <span className="w-full max-w-[860px] text-center text-[70px] font-semibold leading-[1] tracking-[-3px] px-4">
                        ...
                        <span className="inline-block translate-y-2 px-2">
                            ...
                            >
                                ...
                                <defs>
                                    <linearGradient id="paint0_perf" x1="38.6675" y1="4.66406" x2="38.6675" y2="67.3357" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#09CF58" />
                                        <stop offset="1" stopColor="#09CF58" stopOpacity="0" />
                                    </linearGradient>
                                    <clipPath id="clip0_perf">
                                        <rect width="71" height="64" fill="white" transform="translate(3 2.91406)" />
                                    </clipPath>
                                </defs>
                            </svg>
                        </span>
                        ...
                        <div className="mb-3 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex flex-col items-start">
                                    <p className="text-[10px] text-[#AFC1AF]">
                                        Overall Score
                                    </p>
                        ...
                        <div className="mt-3 flex bg-[#052502] py-3 rounded-lg justify-between px-3 gap-5">
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex items-center gap-1.5">
                                    ...
                                    <span className="text-[10px] text-[#A7B0A4]">
                                        Team Members
                                    </span>
                                </div>
                            </div>
